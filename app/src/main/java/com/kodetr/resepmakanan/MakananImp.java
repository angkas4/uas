...
public class MakananImp extends SQLiteOpenHelper implements MakananInterface {
    ...
    public void onCreate(SQLiteDatabase sql) {
        ...
        sql.execSQL("INSERT INTO '" + NAMA_TBL + "' VALUES(1, 'Pelecing', 'https://img-global.cpcdn.com/recipes/00c15ce406741f9b/751x532cq70/pelecing-kangkung-khas-lombok-foto-resep-utama.jpg')");
